...
import com.alliander.open.measure.generator.exporter.velocity.VelocityExporter
import com.alliander.open.measure.generator.exporter.velocity.Configuration
import com.alliander.open.measure.generator.importer.json.JsonImporter
...
class GeneratorArguments(parser: ArgParser) {
    val packageName by parser.storing("-p", "--packageName", help = "the package name for the generated code" ).default("com.alliander.open.measure")
